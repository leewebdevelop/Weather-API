# Weather-API Collaborative Project With Class Mates

Using an API(Application Programming Interface ) to reuqest an remote data set represented in JSON format. Then used the processing functions for working with JSON data to acquire and parse the data
...
Fry 2007, Visualising Data, https://benfry.com/writing/archives/3/

Big List of Free and Open Public API'S (No Auth Needed) https://mixedanalytics.com/blog/list- actually-free-open-no-auth-needed-apis/

Epa Air Quality,  https://erc.epa.ie/air/services/aqih/aqih_dev.php

CSO Databank,  https://statbank.cso.ie/webserviceclient/ (structure can be complex)
